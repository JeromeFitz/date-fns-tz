...
describe("format", function () {
  ...
  describe("time zone", function () {
    ...
    it("https://github.com/marnusw/date-fns-tz/issues/138", () => {
      ...
      const result = format(
        offsetDate,
        "yyyy-MM-dd h:mmaaaaa'm' xxx XXX OOO zzz",
        { timeZone },
      );
    ...
    it("https://github.com/marnusw/date-fns-tz/issues/168", () => {
      ...
      const result = format(offsetDate, "yyyy-MM-dd'T'HH:mm:ss.SSSxxx", {
        timeZone,
      });
